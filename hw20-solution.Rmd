...
```{r}
## Not solvable without data
```

We can however fit a 2-way ANOVA table without an interaction effect with the following table: 
...
More generally, the ANOVA table for a 2-way model without interaction effects is:
