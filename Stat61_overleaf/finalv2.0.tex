...
\item {\bf True \hspace{3mm}or\hspace{3mm} False}\hspace{4mm}  A p-value is a probability evaluated under the assumption that the alternative\\ $\hspace*{3.5cm}$ hypothesis is correct. %\vspace{mm}\\ 
